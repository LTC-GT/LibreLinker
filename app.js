                    ...
                    <div class="border-t border-gray-200 dark:border-gray-700 pt-4">
                        ...
                        <div class="flex items-center gap-4 justify-center">
                            ...
                            <a href="https://bsky.app/profile/libretechgatech.bsky.social" target="_blank" rel="noopener noreferrer" class="hover:opacity-80 transition-opacity" aria-label="Follow us on Bluesky">
                                <svg class="w-6 h-6 fill-current text-gray-300 hover:text-brand-gold transition-colors" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path d="M32 30.2c-3.7-7.2-13.8-18.7-23.1-25.3-2.3-1.6-4.4.2-3 4.3 1.5 4.5 5.6 15.3 9.8 20.6 5.6 7.2 11.6 9.7 16.3 9.2 4.8.5 10.7-2 16.3-9.2 4.2-5.4 8.3-16.1 9.8-20.6 1.4-4.1-.7-5.9-3-4.3C45.8 11.5 35.7 23 32 30.2z"></path>
                                    <path d="M32 34.5c-2.8 5.3-10.5 13.8-17.6 18.7-1.8 1.3-.2 4.3 2.9 4.3 5.1 0 11-3.7 14.7-9.7 3.7 6 9.5 9.7 14.7 9.7 3.1 0 4.7-3 2.9-4.3-7.1-4.9-14.8-13.4-17.6-18.7z"></path>
                                </svg>
                            </a>
